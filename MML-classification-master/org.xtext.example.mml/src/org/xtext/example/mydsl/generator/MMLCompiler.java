...
public class MMLCompiler {
	...
	private String mmlToPython(MMLModel result) throws IOException {
		...
		if (formula != null) {
			...
			//  the formula is not specifier -> Y will be the last column
        ...
        //Tranformation of the Python file into html -> visualisation of the code generated
        Process p2 = Runtime.getRuntime().exec("pygmentize -f html -O full -o target/classes/public/visuPYTHON.html scripts_upload/mml.py ");
		BufferedReader in2 = new BufferedReader(new InputStreamReader(p2.getInputStream()));
		String line2; 
		while ((line2 = in2.readLine()) != null) {
			System.out.println(line2);
	...
	private String mmlToR(MMLModel result) throws IOException {
		...
		Files.write(RCode.getBytes(), new File("scripts_upload/mml.R")); 
		
		
		//execution of the R code
        ...
        //transformation of the R file into html for the visualisation in the web app
        Process p2 = Runtime.getRuntime().exec("pygmentize -f html -O full -o target/classes/public/visuR.html scripts_upload/mml.R ");
		BufferedReader in2 = new BufferedReader(new InputStreamReader(p2.getInputStream()));
		String line2; 
		while ((line2 = in2.readLine()) != null) {
			System.out.println(line2);
