...
results=[['Algorithm', 'Parameters', 'FrameWork', 'balanced_accuracy', 'recall', 'precision']]


try:
	algo = RandomForestClassifier()
	cv_results = cross_validate(algo, X, Y, cv= rkf, scoring=['balanced_accuracy', 'recall_micro', 'precision_micro'])
